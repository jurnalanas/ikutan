...
$query_explore_event = "SELECT * FROM events ORDER BY kategori DESC";
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="content">
					...
					<p><a href="explore.php">Terbaru</a> | <a href="trending.php">Trending</a> | Lokasi</p>
					...
					<form action="shopping-cart.php" method="post" class="shopping-cart">
						<table class="table table-striped">
							<tbody>
                             <tr>
						            <td class="img">Kategori</td>
						            <td class="img">&nbsp;</td>
						            <td class="name">Nama</td>
						            <td class="size">Tanggal</td>
						            <td class="stock lowstock">Lokasi</td>
				              </tr>
							  <?php do { ?>
					         
					          <tr>
						        <td class="img"><span class="label label-info"><?php echo $row_explore_event['kategori']; ?></span></td>
							      ...
							      <td class="stock lowstock"><!--pake gambar aja, cuman udah ada captionnya-->
							      	<?php if ($row_explore_event['tempat']=="tempat/alhur.jpg") {
	echo "Masjid Al-Hurriyah";
} elseif ($row_explore_event['tempat']=="tempat/audit _toyib_faperta.jpg") {
	echo "Audit Toyib Faperta";
} elseif ($row_explore_event['tempat']=="tempat/audit_abdul_muis_fateta.jpg") {
	echo "Audit Abdul Muis Fateta";
} elseif ($row_explore_event['tempat']=="tempat/audit_AHN.jpg") {
	echo "Audit AHN";
} elseif ($row_explore_event['tempat']=="tempat/audit_JHH_fapet.jpg") {
	echo "Audit JHH Fapet";
} elseif ($row_explore_event['tempat']=="tempat/audit_sumardi_fpil.jpg") {
	echo "Audit Sumardi FPIK";
} elseif ($row_explore_event['tempat']=="tempat/gladiator.jpg") {
	echo "Gladiator";
} elseif ($row_explore_event['tempat']=="tempat/gmsk.jpg") {
	echo "GMSK";
} elseif ($row_explore_event['tempat']=="tempat/gww.jpg") {
	echo "GWW";
} elseif ($row_explore_event['tempat']=="tempat/gym.jpg") {
	echo "Gymnasium";
} elseif ($row_explore_event['tempat']=="tempat/korfat.jpg") {
	echo "Koridor Fateta";
} elseif ($row_explore_event['tempat']=="tempat/Koridor_gka.jpg") {
	echo "Koridor GKA";
} elseif ($row_explore_event['tempat']=="tempat/Korpin.jpg") {
	echo "Koridor Pinus";
} elseif ($row_explore_event['tempat']=="tempat/Kortan.jpg") {
	echo "Koridor Tanah";
} elseif ($row_explore_event['tempat']=="tempat/media_center.jpg") {
	echo "Media Center";
} elseif ($row_explore_event['tempat']=="tempat/POMI.jpg") {
	echo "Pojok Mipa";
} elseif ($row_explore_event['tempat']=="tempat/SC_MIPA.jpg") {
	echo "SC MIPA";
}else {
      echo $row_explore_event['tempat']; } ?></td>
