...
<a href="<?php echo $logoutAction ?>"><strong class="btn btn-success">Logout</strong></a>
	...
	<nav class="navbar-collapse collapse" id="main-nav">
		<ul class="nav">
			...
			<li>
			 ...
			 <li>
				<a href="eventsaya.php" class="top-level">Event Saya</a>
	...
	<div style="position: relative; height: 1700px;" id="product-board" class="clearfix">
		...
		<div style="position: absolute; left: 0px; top: 0px;" class="product large cta">
			...
			<a href="explore.php" class="btn btn-bottom">Browse all events →</a>	
		</div>
        <?php do { ?>
	    <div style="position: absolute; left: 400px; top: 0px;" class="product large">
		    <div class="media">
		      <a href="eventitem.php?eventid=<?php echo $row_terbaru['idevent']; ?>" title="product title">
		        <img src="<?php echo $row_terbaru['img']; ?>" alt="product title" data-img="product-1" class="img-responsive">
	          </a>
  ...
  <?php } // Show if first page ?>
		    ...
		    <div class="details">
		      <p class="name"><a href="eventitem.php?eventid=<?php echo $row_terbaru['idevent']; ?>"><?php echo $row_terbaru['nama']; ?></a></p>
		      <a href="" class="details-expand" data-target="details-0001">+</a>
		      </div>
		    <div class="details-extra" id="details-0001">
		      
		      <a href="eventitem.php?eventid=<?php echo $row_terbaru['idevent']; ?>" class="btn btn-bottom btn-atc qadd">Lihat Event</a>			
		      </div>
	      </div>
	    ...
	    <div style="position: absolute; left: 1000px; top: 350px;" class="product medium">
		      <div class="media">
		        <a href="eventitem.php?eventid=<?php echo $row_terlama['idevent']; ?>" title="<?php echo $row_terlama['deskripsi']; ?>">
		          <img src="<?php echo $row_terlama['img']; ?>" alt="product title" data-img="product-1" class="img-responsive">
	            </a>
		        </div>
		      <div class="details">
		        <p class="name"><a href="eventitem.php?eventid=<?php echo $row_terlama['idevent']; ?>"><?php echo $row_terlama['nama']; ?></a></p>
		        <a href="" class="details-expand" data-target="details-0005">+</a>
		        </div>
		      <div class="details-extra" id="details-0005">
		        
		        <a href="eventitem.php?eventid=<?php echo $row_terlama['idevent']; ?>" class="btn btn-bottom btn-atc qadd">Lihat Event</a>			
		        </div>			
	        </div>
...
<?php
mysql_free_result($terbaru);

mysql_free_result($terlama);
?>
