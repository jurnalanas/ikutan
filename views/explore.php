...
$query_explore_event = "SELECT * FROM events ORDER BY idevent DESC";
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="content">
					...
					<p>Terbaru | <a href="trending.php">Trending</a> | <a href="lokasi.php">Lokasi</a></p>
						...
						<table class="table table-striped">
							<tbody>
                             <tr>
						            ...
						            <td class="stock lowstock">Tempat</td>
				              </tr>
							  <?php do { ?>
...
if ($row_explore_event['tempat']=="tempat/alhur.jpg") {
...
?>
								  <?php /*?><?php echo $row_explore_event['tempat']; ?><?php */?>
                                  <!--pake gambar aja, cuman udah ada captionnya-->
                                  </td>
