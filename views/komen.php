				...
				<div class="content">
					...
					<form action="shopping-cart.php" method="post" class="shopping-cart">
						<table class="table table-striped">
							<tbody>
							<tr>
								<td class="img"><img src="asset/product-1-mini.jpg" alt=""></td>
								<td class="name"><a href="index.php/views/eventitem.php">Lari Pagi Sekampung Yok</a></td>
								<td class="size"><span class="size-small">M</span><span class="size-large">Rabu, 27/11/2013</span></td>
								<td class="stock lowstock"><span class="stock-small"></span>Lapangan Gladiator</td>
								<td class="quantity-cell"><a href="eventseya.php" class="cart-remove pull-right"><span class="remove-small">x</span><span class="btn btn-danger">remove</span></a></td>
							  </tr>					
