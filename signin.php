...
if (isset($_POST['username'])) {
  ...
  $LoginRS = mysql_query($LoginRS__query, $localserver) or die(mysql_error());
...
<div class="navbar navbar-toolbar">
  <div class="navbar-inner navbar-fixed-top">
    <a class="brand" href="http://localhost/ikutan">Ikutan</a>
    <ul class="nav">
    ...
    <div class="container">
      ...
      <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" class="form-signin" name="loginForm">
        <h2 class="form-signin-heading"><center>
          <a href="#"class="hint--right  hint--always" data-hint="Ikut event jadi lebih seru!"><img src="views/img/kaoskece.png" alt="KaosKece" width="182" height="160" usemap="#Map">
          </a>
        </center></h2>
